...
let BHNode = function(width, height, parent, nodes){
    ...
    if(this.content.length == 1){
        ...
        if(LU.length != 0)
            this.leftUp = new BHNode([this.dx[0], (this.dx[0] + this.dx[1]) * 0.5], [this.dy[0], (this.dy[0] + this.dy[1]) * 0.5], this, LU);
        if(RU.length != 0)
            this.rightUp = new BHNode([(this.dx[0] + this.dx[1]) * 0.5, this.dx[1]], [this.dy[0], (this.dy[0] + this.dy[1]) * 0.5], this, RU);
        if(LD.length != 0)
            this.leftDown = new BHNode([this.dx[0], (this.dx[0] + this.dx[1]) * 0.5], [(this.dy[0] + this.dy[1]) * 0.5, this.dy[1]], this, LD);
        if(RD.length != 0)
            this.rightDown = new BHNode([(this.dx[0] + this.dx[1]) * 0.5, this.dx[1]], [(this.dy[0] + this.dy[1]) * 0.5, this.dy[1]], this, RD);
    }
